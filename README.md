...
## Deployment
Deployment is easiest using Docker, use the provided docker-compose.yml file as a base for your configuration. Make sure to clone the repository in order to have the rendering api build correctly.
